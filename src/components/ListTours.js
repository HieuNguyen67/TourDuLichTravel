      ...
      <Row className="my-md-5 py-md-2 d-flex flex-row ">
        <Col className="col-6 col-md">
          ...
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <Link to="/TourMienTayTrongNgay" className="text-decoration-none">
        ...
        <Col className="col-6 col-md">
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <Link to="/TourMienTay" className="text-decoration-none">
              <div className="boxlisttour mx-2 box1 my-md-0 my-2">
                <div className="pt-md-4">
                  <p
                    ...
                    style={{ lineHeight: "0.8" }}
                  >
                    <h5 className=" mt-md-5 mt-4 pt-md-5 fontsize">MIỀN TÂY</h5>
                    <h5 className=" fontsize">
                      <b>9</b> Tour
                    </h5>
                  </p>
            ...
            <div className="boxlisttour mx-md-2 mx-1 box2 my-md-0 my-2">
              <div className="pt-md-4">
                <p
                  ...
                  style={{ lineHeight: "0.8" }}
                >
                  <h5 className=" mt-md-5 mt-4 pt-md-5 fontsize1">SÀI GÒN</h5>
                  <h5 className=" fontsize">
                    <b>5</b> Tour
                  </h5>
                </p>
            ...
            <div className="boxlisttour mx-md-2 mx-1 box3 my-md-0 my-2">
              <div className="pt-md-4">
                <p
                  ...
                  style={{ lineHeight: "0.8" }}
                >
                  <h5 className=" mt-md-5 mt-4 pt-md-5 fontsize1">PHÚ QUỐC</h5>
                  <h5 className=" fontsize">
                    <b>4</b> Tour
                  </h5>
                </p>
            ...
            <div className="boxlisttour mx-md-2 mx-1 box4 my-md-0 my-2">
              <div className="pt-md-4">
                <p
                  ...
                  style={{ lineHeight: "0.8" }}
                >
                  <h5 className=" mt-md-5 mt-4 pt-md-5 fontsize1">ĐÀ LẠT</h5>
                  <h5 className=" fontsize">
                    <b>2</b> Tour
                  </h5>
                </p>
